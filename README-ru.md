...
который вам выдается при его создании через [@BotFather](https://t.me/BotFather) — этого бота нужно добавить в ваш канал администратором
...
уведомления — этот ID можно узнать у бота [@Getmyid_bot](https://t.me/Getmyid_bot).
