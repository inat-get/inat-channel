...
конкретного канала вы захотите использовать свой собственный шаблон. [Пример такого](https://github.com/inat-get/channel-ural/blob/main/message.erb) можно 
...
+ **0.9.0** — это можно считать бета-версией или пре-релизом. После небольших доработок будет выпущен релиз 1.0.
